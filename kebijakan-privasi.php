<?php
/**
 * Halaman Legal: Kebijakan Privasi (kebijakan-privasi.php)
...
<head>
  ...
  <title>Kebijakan Privasi & Perlindungan Data — OLX Clone</title>
  <meta name="description" content="Ketahui komitmen OLX Clone dalam melindungi data pribadi, keamanan nomor WhatsApp, dan privasi akun pengguna.">
  ...
  <nav class="breadcrumb-nav" aria-label="Jalur navigasi">
    <div class="container">
      <ul class="breadcrumb">
        ...
        <li aria-current="page">Kebijakan Privasi</li>
      </ul>
    </div>
  </nav>
  ...
  <main class="container info-page-wrapper">
    <article class="info-card">
      <header class="info-header">
        <span class="info-header-badge"><i class="fa-solid fa-user-shield"></i> Perlindungan Privasi</span>
        <h1>Kebijakan Privasi Pengguna OLX Clone</h1>
        <p>Pembaruan Terakhir: 23 September 2026. Menjelaskan bagaimana kami mengumpulkan, menggunakan, dan menjaga data Anda secara bertanggung jawab.</p>
      </header>

      <div class="info-body">
        <h2><i class="fa-solid fa-database" style="color: var(--primary);"></i> 1. Informasi yang Kami Kumpulkan</h2>
        <p>Kami mengumpulkan data yang Anda berikan secara sukarela saat mendaftar atau memperbarui akun, mencakup:</p>
        <ul>
          <li><strong>Identitas Dasar:</strong> Nama lengkap dan alamat email aktif.</li>
          <li><strong>Informasi Kontak:</strong> Nomor WhatsApp yang digunakan untuk memudahkan komunikasi transaksi antara penjual dan pembeli.</li>
          <li><strong>Kredensial Keamanan:</strong> Kata sandi yang dienkripsi menggunakan algoritma BCRYPT yang aman dan tidak dapat dibaca oleh staf kami.</li>
          <li><strong>Data Listing Iklan:</strong> Judul, foto, deskripsi produk, lokasi kota, dan harga yang Anda pasang secara publik.</li>
        </ul>

        <h2><i class="fa-solid fa-lock" style="color: var(--primary);"></i> 2. Penggunaan & Perlindungan Data</h2>
        <p>Data kontak Anda hanya digunakan untuk keperluan fungsionalitas platform, seperti memfasilitasi pesan chat via WhatsApp antar pengguna dan verifikasi kepemilikan akun. Kami tidak pernah menjual atau menyewakan data pribadi Anda kepada pihak ketiga manapun untuk tujuan periklanan tanpa persetujuan Anda.</p>

        <h2><i class="fa-solid fa-cookie-bite" style="color: var(--primary);"></i> 3. Penggunaan Cookie</h2>
        <p>Kami menggunakan session cookie dan cookie preferensi (seperti opsi Ingat Saya) untuk menjaga sesi login Anda tetap aktif serta mengingat preferensi filter wilayah belanja Anda.</p>

        <h2><i class="fa-solid fa-user-pen" style="color: var(--primary);"></i> 4. Hak Pengguna</h2>
        <p>Anda memiliki hak penuh untuk meninjau, memperbarui informasi profil, mengubah nomor WhatsApp, mengganti kata sandi, atau menghapus listing iklan Anda setiap saat melalui menu Edit Profil dan Iklan Saya.</p>
      </div>
    </article>
  </main>
