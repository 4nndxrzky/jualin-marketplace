...
<head>
  ...
  <title>Kebijakan Privasi & Perlindungan Data — Jualin</title>
  <meta name="description" content="Ketahui komitmen Jualin dalam melindungi data pribadi, keamanan nomor WhatsApp, dan privasi akun pengguna.">
  ...
  <main class="container info-page-wrapper">
    <article class="info-card">
      <header class="info-header">
        ...
        <h1>Kebijakan Privasi Pengguna Jualin</h1>
